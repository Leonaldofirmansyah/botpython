                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           aditmadzs.sendMessage(msg._from, "Respon Terkirim\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                 ...
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           aditmadzs.sendMessage(msg.to, "Yang  Ngetag Minta Di Gift Yaa!?\nCek Di Chat, Udah Aku Gift Tuh...")
                           aditmadzs.sendMessage(msg._from, "Gift Terkirim 📲\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        #    if msg._from in admin:
                               ...
                               timeNow = datetime.now(tz=tz)
                               helpMessage = help()
                               aditmadzs.sendMessage(msg.to, "Help Boy_Fira\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                        ...
                        #    if msg._from in admin:
                               ...
                               aditmadzs.sendMessage(msg.to, "Help Fun Boy_Fira\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          #  if msg._from in admin:
                               ...
                               aditmadzs.sendMessage(msg.to, "Meme Boy_Fira\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                               ...
                               aditmadzs.sendMessage(msg.to, "Translate Boy_Fira\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                      ...
                      #      if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                         #   if msg._from in admin:
                               sendMention(msg.to, sender, "「 Boy-FirA™️ SelfBOT」\n")
                      ...
                      #      if msg._from in admin:
                         ...
                         #   if msg._from in admin:
                               eltime = time.time() - mulai
                               bot = "Self Bot Aktif " +waktu(eltime)
...
#===========BOT UPDATE============#
                       ...
                       #     if msg._from in admin:
                                ...
                                for m_id in staff:
                                    ...
                                    aditmadzs.sendMessage(msg.to,"⏩ Boy-FirA™️ BOT\n\n⏩Creator BOT:\n"+ma+"\n⏩Admin:\n"+mb+"\n⏩Staff:\n"+mc+"\n⏩Total「%s」" %(str(len(owner)+len(admin)+len(staff))))
                      ...
                      #     if msg._from in admin:
                       ...
                       #    if msg._from in admin:
                         ...
                         #  if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                          # if msg._from in creator:
                               aditmadzs.sendMessage(msg.to,"SelfBot \n"+aditmadzs.authToken)
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "OTW MASUK KE GROUP : %s" % str(group.name))
